#!/usr/bin/env python3
"""Conservative formatter for Epic source files."""
...
def format_text(text: str, indent_width: int = 4) -> str:
    ...
    for raw_line in text.splitlines(keepends=True):
        ...
        content = line.lstrip(" \t")
        leading_closes, delta = brace_delta(content)
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Format Epic source indentation without changing line breaks."
    )
