...
from x64 import I, M, MS, R, Symbol
...
def append_runtime_helpers(x64, null_deref_label, policy=FULL_RUNTIME):
    if policy != FULL_RUNTIME:
        raise RuntimeError(f"unsupported X64 runtime policy: {policy}")
    _emit_runtime_start(x64)
    emit_x64_runtime_helpers(x64, null_deref_label)


def _emit_runtime_start(x64):
    x64.bind_label(x64.new_symbol_label("__epx_runtime_start"))
    x64.inst("push", R("rbp"))
...
def emit_x64_runtime_helpers(x64, null_deref_label):
    emit_epx_alloc(x64)
    emit_ep_cstr(x64)
    ...
    emit_epx_null_deref(x64, null_deref_label)
...
def emit_epx_alloc(x):
    x.bind_label(x.new_symbol_label("__epx_alloc"))
    x.inst("push", R("rbp"))
...
def emit_ep_cstr(x):
    loop_init = x.new_label()
    loop = x.new_label()
    tail = x.new_label()
    ok = x.new_label()
    fail = x.new_label()
    x.bind_label(x.new_symbol_label("__ep_cstr"))
    x.inst("push", R("rbp"))
    x.inst("mov", R("rbp"), R("rsp"))
    ...
    x.inst("jmp", x.label_ref(loop))
    x.bind_label(tail)
    x.inst("cmp", R("rdx"), I(1))
    x.inst("jz", x.label_ref(ok))
    x.inst("mov", R("r11"), R("r8"))
    x.inst("add", R("r11"), R("r9"))
    x.inst("movzx", R("rax"), M("r11", 0, 1))
    x.inst("test", R("rax"), R("rax"))
    x.inst("jnz", x.label_ref(fail))
    x.bind_label(ok)
...
def emit_ep_write_file(x):
    ...
    x.bind_label(x.new_symbol_label("__ep_write_file"))
    x.inst("push", R("rbp"))
    x.inst("mov", R("rbp"), R("rsp"))
    x.inst("sub", R("rsp"), I(96))
...
def emit_ep_read_file(x):
    ...
    x.bind_label(x.new_symbol_label("__ep_read_file"))
    x.inst("push", R("rbp"))
    x.inst("mov", R("rbp"), R("rsp"))
...
def emit_epx_argv_init(x):
    skip_ws = x.new_label()
    advance_ws = x.new_label()
    arg_start = x.new_label()
    start_plain = x.new_label()
    scan = x.new_label()
    scan_quoted = x.new_label()
    take = x.new_label()
    store_quoted = x.new_label()
    store = x.new_label()
    done = x.new_label()
    x.bind_label(x.new_symbol_label("__epx_argv_init"))
    x.inst("push", R("rbp"))
    x.inst("mov", R("rbp"), R("rsp"))
    ...
    x.inst("mov", R("rcx"), M("rbp", -8))
    x.inst("mov", M("rcx"), R("rax"))
    x.bind_label(skip_ws)
    x.inst("movzx", R("rax"), M("rsi", 0, 1))
    x.inst("mov", R("rcx"), I(0))
    x.inst("cmp", R("rax"), R("rcx"))
    x.inst("jz", x.label_ref(done))
    for value in (32, 9, 13, 10):
        x.inst("mov", R("rcx"), I(value))
        x.inst("cmp", R("rax"), R("rcx"))
        x.inst("jz", x.label_ref(advance_ws))
    x.inst("jmp", x.label_ref(arg_start))
    x.bind_label(advance_ws)
    x.inst("add", R("rsi"), I(1))
    x.inst("jmp", x.label_ref(skip_ws))
    x.bind_label(arg_start)
    x.inst("mov", R("r11"), I(0))
    x.inst("mov", R("rcx"), I(34))
    x.inst("cmp", R("rax"), R("rcx"))
    x.inst("jnz", x.label_ref(start_plain))
    x.inst("mov", R("r11"), I(1))
    x.inst("add", R("rsi"), I(1))
    x.bind_label(start_plain)
    ...
    x.inst("mov", R("rcx"), I(0))
    x.inst("cmp", R("rax"), R("rcx"))
    x.inst("jz", x.label_ref(store))
    x.inst("test", R("r11"), R("r11"))
    x.inst("jnz", x.label_ref(scan_quoted))
    for value in (32, 9, 13, 10):
        x.inst("mov", R("rcx"), I(value))
        x.inst("cmp", R("rax"), R("rcx"))
        x.inst("jz", x.label_ref(store))
    x.inst("jmp", x.label_ref(take))
    x.bind_label(scan_quoted)
    x.inst("mov", R("rcx"), I(34))
    x.inst("cmp", R("rax"), R("rcx"))
    x.inst("jz", x.label_ref(store_quoted))
    x.bind_label(take)
    x.inst("add", R("rsi"), I(1))
    x.inst("add", R("r10"), I(1))
    x.inst("jmp", x.label_ref(scan))
    x.bind_label(store_quoted)
    x.inst("add", R("rsi"), I(1))
    x.bind_label(store)
...
def emit_ep_print_str(x):
    x.bind_label(x.new_symbol_label("__ep_print_str"))
    x.inst("push", R("rbp"))
    x.inst("mov", R("rbp"), R("rsp"))
...
def emit_ep_print_newline(x):
    x.bind_label(x.new_symbol_label("__ep_print_newline"))
    x.inst("push", R("rbp"))
    x.inst("mov", R("rbp"), R("rsp"))
    x.inst("sub", R("rsp"), I(48))
    x.inst("mov", R("rcx"), I(-11))
...
def emit_epx_slice_oob(x):
    x.bind_label(x.new_symbol_label("__epx_slice_oob"))
    x.inst("mov", R("rcx"), I(1))
    x.inst("sub", R("rsp"), I(32))
    x.inst("call", Symbol("ExitProcess"))

def emit_epx_null_deref(x, label):
    x.bind_label(label)
    x.inst("sub", R("rsp"), I(40))
    x.inst("mov", R("rcx"), I(-11))
    x.inst("call", Symbol("GetStdHandle"))
