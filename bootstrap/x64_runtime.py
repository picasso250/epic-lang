...
def emit_epx_cstr(x):
    ...
    x.inst("jz", LabelRef("__epx_cstr.ok"))
    x.inst("mov", R("r11"), R("r8"))
    x.inst("add", R("r11"), R("r9"))
    x.inst("movzx", R("rax"), M("r11", 0, 1))
    x.inst("test", R("rax"), R("rax"))
    x.inst("jnz", LabelRef("__epx_cstr.fail"))
    x.label("__epx_cstr.ok")
