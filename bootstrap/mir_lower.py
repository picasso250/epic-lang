...
class MirLower:
    ...
    def _emit_map_get(self):
        ...
        x.inst("mov", R("r8"), M("rcx", 8))
        x.inst("mov", R("r9"), I(0))
        x.label("__ep_map_str_i64_get.loop")
        x.inst("cmp", R("r9"), R("r8"))
        x.inst("jge", LabelRef("__ep_map_str_i64_get.miss"))
        self._map_entry_addr("r9")
        x.inst("mov", R("rax"), M("r11", 16))
        x.inst("test", R("rax"), R("rax"))
        x.inst("jz", LabelRef("__ep_map_str_i64_get.next"))
        x.inst("mov", R("rax"), M("r11"))
        x.inst("mov", R("rcx"), M("rbp", -16))
        x.inst("cmp", R("rax"), R("rcx"))
        x.inst("jz", LabelRef("__ep_map_str_i64_get.found"))
        x.label("__ep_map_str_i64_get.next")
        x.inst("add", R("r9"), I(1))
        x.inst("jmp", LabelRef("__ep_map_str_i64_get.loop"))
        x.label("__ep_map_str_i64_get.found")
        x.inst("mov", R("rax"), M("r11", 8))
        x.inst("jmp", LabelRef("__ep_map_str_i64_get.done"))
        x.label("__ep_map_str_i64_get.miss")
        x.inst("mov", R("rax"), I(0))
        x.label("__ep_map_str_i64_get.done")
        x.inst("add", R("rsp"), I(32))
        x.inst("pop", R("rbp"))
        x.inst("ret")
    ...
    def _emit_map_set(self):
        ...
        x.inst("mov", R("r8"), M("rcx", 8))
        x.inst("mov", R("r9"), I(0))
        x.label("__ep_map_str_i64_set.loop")
        x.inst("cmp", R("r9"), R("r8"))
        x.inst("jge", LabelRef("__ep_map_str_i64_set.insert"))
        self._map_entry_addr("r9")
        x.inst("mov", R("rax"), M("r11", 16))
        x.inst("test", R("rax"), R("rax"))
        x.inst("jz", LabelRef("__ep_map_str_i64_set.next"))
        x.inst("mov", R("rax"), M("r11"))
        x.inst("mov", R("rcx"), M("rbp", -16))
        x.inst("cmp", R("rax"), R("rcx"))
        x.inst("jz", LabelRef("__ep_map_str_i64_set.update"))
        x.label("__ep_map_str_i64_set.next")
        x.inst("add", R("r9"), I(1))
        x.inst("jmp", LabelRef("__ep_map_str_i64_set.loop"))
        x.label("__ep_map_str_i64_set.update")
        x.inst("mov", R("rax"), M("rbp", -24))
        x.inst("mov", M("r11", 8), R("rax"))
        x.inst("jmp", LabelRef("__ep_map_str_i64_set.done"))
        x.label("__ep_map_str_i64_set.insert")
        x.inst("mov", R("rcx"), M("rbp", -8))
        ...
        x.label("__ep_map_str_i64_set.done")
    ...
    def _emit_map_has(self):
        ...
        x.inst("mov", R("r8"), M("rcx", 8))
        x.inst("mov", R("r9"), I(0))
        x.label("__ep_map_str_i64_has.loop")
        x.inst("cmp", R("r9"), R("r8"))
        x.inst("jge", LabelRef("__ep_map_str_i64_has.no"))
        self._map_entry_addr("r9")
        x.inst("mov", R("rax"), M("r11", 16))
        x.inst("test", R("rax"), R("rax"))
        x.inst("jz", LabelRef("__ep_map_str_i64_has.next"))
        x.inst("mov", R("rax"), M("r11"))
        x.inst("mov", R("rcx"), M("rbp", -16))
        x.inst("cmp", R("rax"), R("rcx"))
        x.inst("jz", LabelRef("__ep_map_str_i64_has.yes"))
        x.label("__ep_map_str_i64_has.next")
        x.inst("add", R("r9"), I(1))
        x.inst("jmp", LabelRef("__ep_map_str_i64_has.loop"))
        x.label("__ep_map_str_i64_has.yes")
        x.inst("mov", R("rax"), I(1))
        x.inst("jmp", LabelRef("__ep_map_str_i64_has.done"))
        x.label("__ep_map_str_i64_has.no")
        x.inst("mov", R("rax"), I(0))
        x.label("__ep_map_str_i64_has.done")
        x.inst("add", R("rsp"), I(32))
        x.inst("pop", R("rbp"))
        x.inst("ret")
    ...
    def _emit_system_cmd(self):
        ...
        x.inst("test", R("rax"), R("rax"))
        x.inst("jnz", LabelRef("__ep_system_cmd.ok"))
        x.inst("mov", R("rax"), I(-1))
        x.inst("jmp", LabelRef("__ep_system_cmd.done"))
        x.label("__ep_system_cmd.ok")
    ...
    def _emit_str_i64(self):
        ...
        x.inst("mov", R("r8"), I(0))
        x.inst("test", R("rax"), R("rax"))
        x.inst("jns", LabelRef("__ep_str_from_i64.positive"))
        x.inst("neg", R("rax"))
        x.inst("mov", R("r8"), I(1))
        x.label("__ep_str_from_i64.positive")
        x.inst("test", R("rax"), R("rax"))
        x.inst("jnz", LabelRef("__ep_str_from_i64.loop"))
        x.inst("dec", R("r10"))
        x.inst("mov", M("r10", 0, 1), I(48))
        x.inst("inc", R("r11"))
        x.inst("jmp", LabelRef("__ep_str_from_i64.digits_done"))
        x.label("__ep_str_from_i64.loop")
        ...
        x.inst("test", R("rax"), R("rax"))
        x.inst("jnz", LabelRef("__ep_str_from_i64.loop"))
        x.label("__ep_str_from_i64.digits_done")
        x.inst("test", R("r8"), R("r8"))
        x.inst("jz", LabelRef("__ep_str_from_i64.finish"))
        x.inst("dec", R("r10"))
        x.inst("mov", M("r10", 0, 1), I(45))
        x.inst("inc", R("r11"))
        x.label("__ep_str_from_i64.finish")
        ...
        x.label("__ep_str_from_i64.copy")
        x.inst("test", R("rdx"), R("rdx"))
        x.inst("jz", LabelRef("__ep_str_from_i64.copy_done"))
        x.inst("movzx", R("rax"), M("rsi", 0, 1))
        x.inst("mov", M("rdi", 0, 1), R("al"))
        x.inst("add", R("rsi"), I(1))
        x.inst("add", R("rdi"), I(1))
        x.inst("dec", R("rdx"))
        x.inst("jmp", LabelRef("__ep_str_from_i64.copy"))
        x.label("__ep_str_from_i64.copy_done")
