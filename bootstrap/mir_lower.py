...
class MirLower:
    ...
    def _emit_str_eq(self):
        x = self.x64
        x.label("str_eq")
        x.inst("mov", R("r8"), M("rcx", 8))
        x.inst("mov", R("r9"), M("rdx", 8))
        x.inst("cmp", R("r8"), R("r9"))
        x.inst("jnz", LabelRef("str_eq.no"))
        x.inst("mov", R("r10"), M("rcx"))
        x.inst("mov", R("r11"), M("rdx"))
        x.inst("test", R("r8"), R("r8"))
        x.inst("jz", LabelRef("str_eq.yes"))
        x.label("str_eq.loop")
        x.inst("movsx", R("rax"), M("r10", 0, 1))
        x.inst("movsx", R("r9"), M("r11", 0, 1))
        x.inst("cmp", R("rax"), R("r9"))
        x.inst("jnz", LabelRef("str_eq.no"))
        x.inst("add", R("r10"), I(1))
        x.inst("add", R("r11"), I(1))
        x.inst("dec", R("r8"))
        x.inst("jnz", LabelRef("str_eq.loop"))
        x.label("str_eq.yes")
        x.inst("mov", R("rax"), I(1))
        x.inst("ret")
        x.label("str_eq.no")
