; ── _extend_u8: append src u8[] bytes into dst u8[] ──
...
_extend_u8:
    ...
    jge _extend_u8_have_cap

    mov r8, [rcx+16]
    test r8, r8
    jnz _extend_u8_cap_loop
    mov r8, 2
_extend_u8_cap_loop:
    cmp r8, [rbp-48]
    jge _extend_u8_cap_ready
    add r8, r8
