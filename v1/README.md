...
From the repository root, the top-level bootstrap script can produce the v0
anchor:
...
From `v1/`, run the example suite with the previous Epic compiler as the anchor:
...
See `design.md` for the current design notes.
