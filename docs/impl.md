...
src/lexer.ep、src/parser.ep、src/sema.ep 和 src/link.ep 仍保留为 Epic-written 工具源码。旧 src/codegen_support.ep / src/codegen.ep 走 NASM 文本汇编路线，已删除；当前编译后端以 Python reference compiler 的 MIR -> X64IR -> machine path 为准。
